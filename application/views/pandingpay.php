...
//$catewgory1 = $tyhis->Common_model->getSingleRecordsById('org_list',array['id'=> $getdata('user_id1')]);
                    ...
                    <tr>
                     ...
                     <!-- <td>
                        ...
                        <td>
   <a href="<?php echo base_url() ?>welcome/viewpayment/<?php echo  $getdata['user_id']; ?>" title="view"> <img src="<?php echo base_url();?>home/assets/vendors/images/view.png" alt="" class="dark-logo" style="width:20px;height:20px;"/></a>  

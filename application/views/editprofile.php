...
<input type="text" class="form-control" id="exampleInputEmail1"value="<?php if(!empty($tax_data['pwd'])){echo $tax_data['pwd'];}else{echo '';}?>" name="pwd" aria-describedby="emailHelp" placeholder="Enter Password">

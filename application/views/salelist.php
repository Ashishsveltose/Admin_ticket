            ...
            <div class="pd-ltr-20 xs-pd-20-10">
                <div class="min-height-200px">
                            ...
                            <div class="col-md-12">
                              <!--<div class="col-6">-->
                                <div class="pd-20 float-right">
                                    <a href="https://invoice-o.com/websoft/addsales" class="dropdown-toggle no-arrow">
                                        <button type="button" class="btn btn-primary">Add Sales</button>
                                    </a> 
                              </div>
                              <!--   </div> -->
                  ...
                  ?>
                    ...
                    <td><?php  echo (!empty($getdata['lastname'])?$getdata['lastname']:'none'); ?></td>
...
$(document).ready(function(){
  ...
  $(".dropdown-itemm").click(function(e){
    var val = confirm("Are you sure, you want to delete sales ?");
    if (val == true){
    ...
    if(val){
      $.ajax({
        ...
        data:{table:'agent',id:id,status:3,colwhr:'id',whrstatuscol:'status',action:"Delete"},
        dataType:'json',
  ...
  $(".deactive").click(function(e){
        var val = confirm("Are you sure, you want to deactivate sales ?");
        if (val == true){
      window.location.reload();
    }
  ...
  $(".useractive").click(function(e){
    var val = confirm("Are you, sure you want to activate sales ?");
    if (val == true){
      window.location.reload();
    }
    ...
    if(val){
      $.ajax({
        type: "POST",
        url: "<?php echo base_url();?>admin/welcome/change_status",
        data:{tablename:'agent',id:id,status:1,whrcol:'id',whrstatuscol:'status',action:"Active"},
        dataType:'json',
        success: function(response) {
          if (response.status == 1){
            $.notify(response.msg, "success");

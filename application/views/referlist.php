                ...
                <div class="min-height-200px">
                  ...
                  ?>
                    ...
                    <td><?php  echo (!empty($getdata['username'])?$getdata['username']:'none'); ?></td>
                      <td>Active</td>
                        <td><?php  echo (!empty($getdata['commission'])?$getdata['commission']:'none'); ?></td>
...
$(document).ready(function(){
  ...
  $(".dropdown-item").click(function(e){
    var val = confirm("Are you sure, you want to delete refer ?");
    if (val == true){
    ...
    if(val){
      $.ajax({
        ...
        data:{table:'refer',id:id,status:3,colwhr:'id',whrstatuscol:'status',action:"Delete"},
        dataType:'json',

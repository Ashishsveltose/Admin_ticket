        ...
        <div class="xs-pd-20-10 pd-ltr-20">
            ...
            <div class="pd-ltr-20 xs-pd-20-10">
                <div class="min-height-200px">
                                        ...
                                        <button type="button" class="btn btn-primary">Add Category</button>
                                                            ...
                                                            <div class="row">
                                                                <div class="mb-3 col-md-6">
                                                                    ...
                                                                    <input name="yourfirstname" type="text" value="<?php echo $admin_information['name'];?>" class="form-control" placeholder="First Name" autofocus required/>

                                                                </div>
                                                              <div class="mb-3 col-md-6">
                                                                    <label class="form-label">lastname</label>
                  <input name="yourlastname" type="text" value="<?php echo $admin_information['lastname'];?>" class="form-control" placeholder="Last Name" required/>
                  ...
                  <input name="yourpassword" type="text" value="<?php echo $admin_information['password'];?>" class="form-control" placeholder="Password" required/>
                                                                </div>
												...
												<div class="modal-body">
                                                      ...
                                                      <form action="" method="post">
                                                            <div class="row">
                                                                <div class="mb-3 col-md-6">
                                                                    <label class="form-label">firstname</label>
                                                                    <input name="yourfirstname" type="text" value="<?php echo $admin_information['firstname'];?>" class="form-control" placeholder="First Name" autofocus required/>

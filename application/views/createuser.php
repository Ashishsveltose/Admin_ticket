                                ...
                                <div class="row">
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="fullName" placeholder="Enter full name" value="<?php if(!empty($tax_data['full_name'])){echo $tax_data['full_name'];}else{echo '';}?>" name="full_name" required>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
                  ...
                  ?>
                                    ...
                                    <div class="col-md-4">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control" id="phone" placeholder="Enter phone number" value="<?php if(!empty($tax_data['phone'])){echo $tax_data['phone'];}else{echo '';}?>" name="phone" required>
                                        </div>
                                    </div>
                                    <div class="col-md-4">
                                        <div class="form-group">
...
$category1 = $this->Common_model->getSingleRecordById('business_area',array('id'=> $getdata['busi_area']));
       ...
       ?>
                        ...
                        <?php } ?>
                                            ...
                                            <td>
                                                <a   style="margin-left:10px;" href="<?php echo base_url() ?>welcome/createuser/<?php echo $getdata['id']; ?>" title="Edit">

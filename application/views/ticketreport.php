...
<a href='https://chauffit.com/ticket_admin/exportuserreport' class="btn btn-primary">Export</a> 
    ...
    foreach ($taxlist as $getdata) { 
       ...
       ?>
                                           <tr>
                                            ...
                                            <td><?php 
    echo !empty($getdata['created_date']) 
        ? date('d-m-Y', strtotime($getdata['created_date'])) 
        : 'none'; 
    ?></td>
...
<?php } if($getdata['status'] == 4){?>
                        ...
                        <?php } ?>  
                          ...
                          <td>
                          <a href="https://chauffit.com/ticket_admin/welcome/replyview/<?php echo htmlspecialchars($getdata['id']); ?>" >
  ...
  <path d="M15.854.146a.5.5 0 0 1 .11.54l-5.819 14.547a.75.75 0 0 1-1.329.124l-3.178-4.995L.643 7.184a.75.75 0 0 1 .124-1.33L15.314.037a.5.5 0 0 1 .54.11ZM6.636 10.07l2.761 4.338L14.13 2.576zm6.787-8.201L1.591 6.602l4.339 2.76z"/>
          ...
          <td><?php echo (!empty($category2['full_name']) ? $category2['full_name'] : 'none'); ?></td>
...
<script>
    function business() {
        ...
        window.location.href = 'https://chauffit.com/ticket_admin/addticket';
    }
</script>

							...
							<form method="post" >
								...
								<div class="select-role">
									<div class="btn-group btn-group-toggle" data-toggle="buttons">
										<label class="btn active">
											...
											<div class="icon">
												<img
													src="<?php echo base_url();?>home/assets/vendors/images/briefcase.svg"
													class="svg"
													alt=""
												/>
											</div>
										...
										<label class="btn">
											...
											<div class="icon">
												<img
													src="<?php echo base_url();?>home/assets/vendors/images/person.svg"
													class="svg"
													alt=""
												/>
											</div>
								...
								<div class="input-group custom">
									<input
										...
										placeholder="Username"name="username" placeholder="username" value="<?php echo (!empty($customer_data) && !empty($customer_data['username']) ? $customer_data['username'] : "" )?>" required
									/>
								...
								<div class="input-group custom">
									<input
										type="password"
										class="form-control form-control-lg"
										placeholder="**********"name="password"value="<?php echo (!empty($customer_data) && !empty($customer_data['password']) ? $customer_data['password'] : "" )?>" required
									/>
									<div class="input-group-append custom">
										<span class="input-group-text"

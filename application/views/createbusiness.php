...
<?php endif; ?>
                                            ...
                                            <form role="form" class="m-3" enctype="multipart/form-data" method="post" action="">

<div class="row">
    <div class="col-md-6">
 <label for="exampleInputEmail1">Business Area Name
</label>
<input type="text" class="form-control" id="exampleInputEmail1"value="<?php if(!empty($tax_data['area_name'])){echo $tax_data['area_name'];}else{echo '';}?>" name="area_name" aria-describedby="emailHelp" placeholder="Enter business area name" required>
                                    
    </div>
    <div class="col-md-6">
 <label for="exampleInputEmail1">Note
</label>
<input type="text" class="form-control" id="exampleInputEmail1"value="<?php if(!empty($tax_data['note'])){echo $tax_data['note'];}else{echo '';}?>" name="note" aria-describedby="emailHelp" placeholder="Enter note" required>

...
<div class="row">
    <div class="col-md-6">
 <label for="exampleInputEmail1">Role Name
</label>
<input type="text" class="form-control" id="exampleInputEmail1"value="<?php if(!empty($tax_data['role'])){echo $tax_data['role'];}else{echo '';}?>" name="role" aria-describedby="emailHelp" placeholder="Enter Role">

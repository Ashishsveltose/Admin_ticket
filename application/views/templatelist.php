            ...
            <div class="pd-ltr-20 xs-pd-20-10">
                <div class="min-height-200px">
                            ...
                            <div class="col-md-12">
                              <!--<div class="col-6">-->
                                <div class="pd-20 float-right">
                                    <a href="https://invoice-o.com/newproject/addtemplate" class="dropdown-toggle no-arrow">
                  ...
                  ?>
                    ...
                    <td><?php  echo (!empty($getdata['template_name'])?$getdata['template_name']:'none'); ?></td>
...
$(document).ready(function(){
  ...
  $(".dropdown-itemm").click(function(e){
    var val = confirm("Are you sure, you want to delete template ?");
    if (val == true){
  ...
  $(".deactive").click(function(e){
        var val = confirm("Are you sure, you want to deactivate template ?");
        if (val == true){
      window.location.reload();
    }
  ...
  $(".useractive").click(function(e){
    var val = confirm("Are you, sure you want to activate template ?");
    if (val == true){
      window.location.reload();
    }
    ...
    if(val){
      $.ajax({
        type: "POST",
        url: "<?php echo base_url();?>admin/welcome/change_status",
        data:{tablename:'template',id:id,status:1,whrcol:'id',whrstatuscol:'status',action:"Active"},
        dataType:'json',
        success: function(response) {
          if (response.status == 1){
            $.notify(response.msg, "success");

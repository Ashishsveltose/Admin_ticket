...
<input type="text" class="form-control" id="exampleInputEmail1"value="<?php if(!empty($tax_data['company_name'])){echo $tax_data['company_name'];}else{echo '';}?>" name="company_name" aria-describedby="emailHelp" placeholder="Enter company  name" required>

...
<h7>You Want to Add  Sub category?</h7>
</div>
...
<script>
    $(document).ready(function() {
        $("#yesButton").click(function() {
            window.location.href = 'https://invoice-o.com/websoft/addsubcategory';
        });
    });
</script>
<script>
    $(document).ready(function() {
        $("#noButton").click(function() {
            window.location.href = 'https://invoice-o.com/websoft/newcategory';
        });
    });
</script>

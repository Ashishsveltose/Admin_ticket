...
//$catewgory1 = $tyhis->Common_model->getSingleRecordsById('org_list',array['id'=> $getdata('user_id1')]);
                   ...
                   $category1 = $this->Common_model->getSingleRecordById('org_list',array('id'=> $getdata['user_id']));
                    ...
                    <tr>
                      ...
                      <td><?php  echo (!empty($category2['firstname'])?$category2['firstname']:'none'); ?></td>
                      ...
                      <!--<a href="<?php //echo base_url() ?>welcome/edit_receipt/<?php // echo  $getdata['id']; ?>" title="Edit"><img src="<?php echo base_url();?>home/assets/vendors/images/edit.png" alt="" class="dark-logo" style="width:20px;height:20px;"/></a>-->  
 ...
 <!--<a href="javascript:void(0)" href-data="<?php //echo  $getdata['id']; ?>" class="dropdown-itemm" title="Delete"><i class="dw dw-delete-3" aria-hidden="true"></i></a>-->
              ...
              <a href="<?php echo base_url() ?>welcome/viewreceipt/<?php echo  $getdata['user_id']; ?>" title="view"> <img src="<?php echo base_url();?>home/assets/vendors/images/view.png" alt="" class="dark-logo" style="width:20px;height:20px;"/></a>  

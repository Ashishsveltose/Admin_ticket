                  ...
                  <div class="col-md-4">
                    ...
                    <div class="input-group custom">
                      <input
                        type="text"
                        class="form-control form-control-lg"
                        placeholder="card_number"value="<?php if(!empty($tax_data['card_number'])){echo $tax_data['card_number'];}else{echo '';}?>" name="card_number"
                      />
                    </div>
                  </div>
                  <div class="col-md-4">
                    ...
                    <div class="input-group custom">
                      <input
                        type="text"
                        class="form-control form-control-lg"
                        placeholder="cvv no."value="<?php if(!empty($tax_data['cvv'])){echo $tax_data['cvv'];}else{echo '';}?>" name="cvv"
                      />
                    </div>
                  </div>
                  <div class="col-md-6">

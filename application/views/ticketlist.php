                ...
                <div class="col-xl-12">
                    <div class="card">
                        <div class="card-header">
                            <div class="row">
                                <div class="col-md-4">
<button type="button" class="btn btn-primary" onclick="business()">Create Ticket</button>
...
<?php } if($getdata['status'] == 4){?>
                        ...
                        <?php } ?>  
                          ...
                          <td>
                          <a href="https://supporthub.xytr.org/ticket_admin/welcome/replyview/<?php echo htmlspecialchars($getdata['id']); ?>" >

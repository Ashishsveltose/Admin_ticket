            ...
            <div class="pd-ltr-20 xs-pd-20-10">
                <div class="min-height-200px">
                        ...
                        <div class="row">
                            ...
                            <div class="col-6">
                                <div class="pd-20 float-right">
                                    <a href="https://edumatelive.in/newadmin/addservice" class="dropdown-toggle no-arrow">
                  ...
                  ?>
                    ...
                    <td><?php  echo (!empty($getdata['category'])?$getdata['category']:'none'); ?></td>
                      <td><?php  echo (!empty($getdata['subcategory'])?$getdata['subcategory']:'none'); ?></td>
                    <td><?php  echo (!empty($getdata['seller_name'])?$getdata['seller_name']:'none'); ?></td>
                      ...
                      <td>
                                                    <div class="mb-30 switch-btn">
                                                        <input type="checkbox" checked class="switch-btn"
                                                            data-size="small" data-color="#0099ff" />
                                                    </div>
                                                </td>
                                                <td><a href="add-attribute.html" class="dropdown-toggle no-arrow">
                                                        <button type="button" class="btn btn-primary">Add
                                                            Attribute</button></a></td>
                                                <td>
...
$(document).ready(function(){
  ...
  $(".dropdown-item").click(function(e){
    var val = confirm("Are you sure, you want to delete Seller Service ?");
    if (val == true){
    ...
    if(val){
      $.ajax({
        ...
        data:{table:'sellerservice',id:id,status:3,colwhr:'id',whrstatuscol:'status',action:"Delete"},
        dataType:'json',
